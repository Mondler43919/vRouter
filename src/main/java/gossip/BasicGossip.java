...
public class BasicGossip extends SingleValueHolder implements CDProtocol {
    ...
    public void nextCycle(Node node, int protocolID) {
        ...
        for (int i = 0; i < linkable.degree(); ++i) {
            ...
            if (!peer.isUp())
                continue;
            BasicGossip n = (BasicGossip) peer.getProtocol(protocolID);
            if (n.quota == 0.0)
                continue;
     ...
     *            instance of the {@link BasicGossip}
     *            class.
     */
    protected void doTransfer(BasicGossip neighbor) {
